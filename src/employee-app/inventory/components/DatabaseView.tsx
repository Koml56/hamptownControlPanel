...
import { Upload, Plus, Download, Search, Edit3, Trash2, X, AlertTriangle, Tag } from 'lucide-react';
      ...
      <div className="bg-white rounded-xl p-6 max-w-md w-full mx-4">
        ...
        <div className="mb-4 p-3 bg-gray-50 rounded-lg">
          <div className="flex items-center">
            <span className="text-2xl mr-3">{getCategoryIcon(item.isAssigned && item.assignedCategory ? item.assignedCategory : (item.type || 'supplies'), customCategories)}</span>
            <div>
