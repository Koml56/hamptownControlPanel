// SyncStatusIndicator.tsx - Updated for default multi-device sync
    ...
    if (connectionStatus === 'connected' && lastSync) {
      return {
        icon: showSyncPulse ? 
          ...
          (deviceCount > 1 ? <Users className="w-3 h-3" /> : <Globe className="w-3 h-3" />),
        text: showSyncPulse ? (recentSyncEvent ? `Syncing ${recentSyncEvent.field || 'data'}` : 'Syncing') : 
              (deviceCount > 1 ? `${deviceCount} devices` : 'Synced'),
        ...
        {showDetails && !isDragging && (
          ...
          >
            ...
            <div className="relative bg-white/95 backdrop-blur-xl rounded-xl shadow-xl border border-white/50 overflow-hidden">
              {/* Enhanced header */}
              <div className="bg-gradient-to-r from-emerald-500/15 to-blue-500/15 px-4 py-3 border-b border-white/30">
              ...
              <div className="p-4 space-y-4 max-h-80 overflow-y-auto">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 py-2 px-3 bg-gradient-to-r from-emerald-500 to-blue-500 
                  ...
                  <button
                    ...
                    className="py-2 px-3 bg-white/20 backdrop-blur-sm border border-white/30 
                             text-gray-700 rounded-lg hover:bg-white/30 
                             transition-all duration-300 text-xs font-semibold"
                    title={isMultiDeviceEnabled ? 'Disable sync' : 'Enable sync'}
                  >
